...
export function BuyVsRentSimulator() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-6 sm:px-6 lg:grid-cols-12">
          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              <div>
                ...
                <Slider min={30} max={80} step={1} value={[surface]} onValueChange={(v) => setSurface(v[0])} />
              </div>
        ...
        <section className="space-y-4 lg:col-span-3">
          <Card>
            ...
            <CardContent className="space-y-5">
              <SliderRow label="Apport" value={apport} unit="€" min={0} max={100000} step={1000} onChange={setApport} />
              <SliderRow
                ...
                onChange={setTaux}
              />
              <SliderRow label="Durée du prêt" value={duree} unit="ans" min={10} max={25} step={1} onChange={setDuree} />
            </CardContent>
          </Card>
        ...
        <section className="space-y-4 lg:col-span-6">
          <div className="grid grid-cols-2 gap-3">
            ...
            <KPI label="Mensualité totale" value={fmtEUR(sim.mensualiteTotale)} hint="crédit + assurance" />
            <KPI
              ...
              <div style={{ width: "100%", height: 380 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={sim.series} margin={{ top: 10, right: 20, left: 0, bottom: 5 }}>
                    ...
                    <Line type="monotone" dataKey="coutProprietaire" name="Cumul coûts propriétaire" stroke="#dc2626" strokeWidth={2} dot={false} />
                    <Line type="monotone" dataKey="coutLocataire" name="Cumul loyers locataire" stroke="#f59e0b" strokeWidth={2} dot={false} />
                    <Line type="monotone" dataKey="patrimoineNet" name="Patrimoine net" stroke="#2563eb" strokeWidth={2.5} dot={false} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
            ...
            <Card>
              ...
              <CollapsibleContent>
                <CardContent className="space-y-1.5 text-sm text-muted-foreground">
                  ...
                  <p>• Loyer équivalent : rendement brut {(city.yield * 100).toFixed(1)} % / an du prix du bien</p>
                  <p>• Entretien automatique : 0,5 % du prix du bien / an</p>
                  <p>• Patrimoine net = valeur revalorisée du bien − capital restant dû (hors fiscalité de revente)</p>
                  <p>• Données prix/m² : MeilleursAgents 2024 (estimations, modifiables).</p>
                </CardContent>
              </CollapsibleContent>
            </Card>
          </Collapsible>
