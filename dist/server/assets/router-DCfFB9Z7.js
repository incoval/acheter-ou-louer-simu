...
const appCss = "/acheter-ou-louer-simu/assets/styles-qdiGns9X.css";
...
const $$splitComponentImporter = () => import("./index-DNUsP_ma.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Comparez l'achat et la location de votre résidence principale dans les 10 plus grandes villes françaises. Calcul du seuil de rentabilité, mensualité et patrimoine net."
    }]
  })
});
...
const getRouter = () => {
  const router2 = createRouter({
    basename: "/acheter-ou-louer-simu/",
    routeTree,
    context: {},
