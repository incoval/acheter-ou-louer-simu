...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Cpd6q3Zh.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DCfFB9Z7.js").then((n2) => n2.a),
...
var ROUTER_BASEPATH = "acheter-ou-louer-simu";
var SERVER_FN_BASE = "/acheter-ou-louer-simu/_serverFn/";
